...
import net.yw.shoppingbackend.dao.CategoryDAO;
...
public class CategoryTestCase {
	 ...
	 * assertEquals("Successfully retrieve the category list in the table!", 0,
	...
	public void testCRUDCategory() {
		...
		//Update the category which id = 3
		...
		//Fectch the list of category
		assertEquals("Successfully retrieve the category list in the table!", 1, categoryDAO.list().size());
	}
